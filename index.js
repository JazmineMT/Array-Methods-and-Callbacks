...
console.log(fifaData[1]["Away Team Name"]);
console.log(fifaData[1]["Home Team Goals"]);
console.log(fifaData[1]["Away Team Goals"]);
console.log(fifaData[1]["Win Conditions"]);
